...
var file_docker_v1_docker_proto_goTypes = []any{
	...
	(*HostStatsResponse)(nil),         // 49: docker.v1.HostStatsResponse
...
var file_docker_v1_docker_proto_depIdxs = []int32{
	...
	62, // 11: docker.v1.Image.labels:type_name -> docker.v1.Image.LabelsEntry
	...
	52, // 17: docker.v1.StatsResponse.system:type_name -> docker.v1.SystemInfo
	55, // 18: docker.v1.StatsResponse.containers:type_name -> docker.v1.ContainerStats
	59, // 19: docker.v1.StatsRequest.file:type_name -> docker.v1.ComposeFile
	...
	63, // 22: docker.v1.ListResponse.statusCount:type_name -> docker.v1.ListResponse.StatusCountEntry
	54, // 23: docker.v1.ListResponse.list:type_name -> docker.v1.ContainerList
	56, // 24: docker.v1.ContainerList.ports:type_name -> docker.v1.Port
	3,  // 25: docker.v1.ComposeFileStatusResponse.StatusEntry.value:type_name -> docker.v1.Status
	58, // 26: docker.v1.DockerService.ContainerStart:input_type -> docker.v1.ContainerRequest
	58, // 27: docker.v1.DockerService.ContainerStop:input_type -> docker.v1.ContainerRequest
	58, // 28: docker.v1.DockerService.ContainerRemove:input_type -> docker.v1.ContainerRequest
	58, // 29: docker.v1.DockerService.ContainerRestart:input_type -> docker.v1.ContainerRequest
	58, // 30: docker.v1.DockerService.ContainerUpdate:input_type -> docker.v1.ContainerRequest
	...
	51, // 33: docker.v1.DockerService.ContainerStats:input_type -> docker.v1.StatsRequest
	51, // 34: docker.v1.DockerService.ContainerStatsStream:input_type -> docker.v1.StatsRequest
	57, // 35: docker.v1.DockerService.HostStats:input_type -> docker.v1.Empty
	47, // 36: docker.v1.DockerService.ContainerLogs:input_type -> docker.v1.ContainerLogsRequest
	47, // 37: docker.v1.DockerService.ContainerInspect:input_type -> docker.v1.ContainerLogsRequest
	59, // 38: docker.v1.DockerService.ComposeUp:input_type -> docker.v1.ComposeFile
	59, // 39: docker.v1.DockerService.ComposeDown:input_type -> docker.v1.ComposeFile
	59, // 40: docker.v1.DockerService.ComposeStart:input_type -> docker.v1.ComposeFile
	59, // 41: docker.v1.DockerService.ComposeStop:input_type -> docker.v1.ComposeFile
	59, // 42: docker.v1.DockerService.ComposeRestart:input_type -> docker.v1.ComposeFile
	59, // 43: docker.v1.DockerService.ComposeUpdate:input_type -> docker.v1.ComposeFile
	59, // 44: docker.v1.DockerService.ComposeList:input_type -> docker.v1.ComposeFile
	59, // 45: docker.v1.DockerService.ComposeValidate:input_type -> docker.v1.ComposeFile
	2,  // 46: docker.v1.DockerService.ComposeFileStatus:input_type -> docker.v1.ComposeFileStatusRequest
	26, // 47: docker.v1.DockerService.ImageList:input_type -> docker.v1.ListImagesRequest
	28, // 48: docker.v1.DockerService.ImageRemove:input_type -> docker.v1.RemoveImageRequest
	31, // 49: docker.v1.DockerService.ImagePruneUnused:input_type -> docker.v1.ImagePruneRequest
	17, // 50: docker.v1.DockerService.ImageInspect:input_type -> docker.v1.ImageInspectRequest
	34, // 51: docker.v1.DockerService.VolumeList:input_type -> docker.v1.ListVolumesRequest
	36, // 52: docker.v1.DockerService.VolumeCreate:input_type -> docker.v1.CreateVolumeRequest
	38, // 53: docker.v1.DockerService.VolumeDelete:input_type -> docker.v1.DeleteVolumeRequest
	41, // 54: docker.v1.DockerService.NetworkList:input_type -> docker.v1.ListNetworksRequest
	43, // 55: docker.v1.DockerService.NetworkCreate:input_type -> docker.v1.CreateNetworkRequest
	45, // 56: docker.v1.DockerService.NetworkDelete:input_type -> docker.v1.DeleteNetworkRequest
	13, // 57: docker.v1.DockerService.NetworkInspect:input_type -> docker.v1.NetworkInspectRequest
	48, // 58: docker.v1.DockerService.ContainerStart:output_type -> docker.v1.LogsMessage
	48, // 59: docker.v1.DockerService.ContainerStop:output_type -> docker.v1.LogsMessage
	48, // 60: docker.v1.DockerService.ContainerRemove:output_type -> docker.v1.LogsMessage
	48, // 61: docker.v1.DockerService.ContainerRestart:output_type -> docker.v1.LogsMessage
	57, // 62: docker.v1.DockerService.ContainerUpdate:output_type -> docker.v1.Empty
	6,  // 63: docker.v1.DockerService.ContainerTop:output_type -> docker.v1.ContainerTopResponse
	53, // 64: docker.v1.DockerService.ContainerList:output_type -> docker.v1.ListResponse
	50, // 65: docker.v1.DockerService.ContainerStats:output_type -> docker.v1.StatsResponse
	55, // 66: docker.v1.DockerService.ContainerStatsStream:output_type -> docker.v1.ContainerStats
	49, // 67: docker.v1.DockerService.HostStats:output_type -> docker.v1.HostStatsResponse
	48, // 68: docker.v1.DockerService.ContainerLogs:output_type -> docker.v1.LogsMessage
	9,  // 69: docker.v1.DockerService.ContainerInspect:output_type -> docker.v1.ContainerInspectMessage
	48, // 70: docker.v1.DockerService.ComposeUp:output_type -> docker.v1.LogsMessage
	48, // 71: docker.v1.DockerService.ComposeDown:output_type -> docker.v1.LogsMessage
	48, // 72: docker.v1.DockerService.ComposeStart:output_type -> docker.v1.LogsMessage
	48, // 73: docker.v1.DockerService.ComposeStop:output_type -> docker.v1.LogsMessage
	48, // 74: docker.v1.DockerService.ComposeRestart:output_type -> docker.v1.LogsMessage
	48, // 75: docker.v1.DockerService.ComposeUpdate:output_type -> docker.v1.LogsMessage
	53, // 76: docker.v1.DockerService.ComposeList:output_type -> docker.v1.ListResponse
	...
	42, // 86: docker.v1.DockerService.NetworkList:output_type -> docker.v1.ListNetworksResponse
	44, // 87: docker.v1.DockerService.NetworkCreate:output_type -> docker.v1.CreateNetworkResponse
	46, // 88: docker.v1.DockerService.NetworkDelete:output_type -> docker.v1.DeleteNetworkResponse
	14, // 89: docker.v1.DockerService.NetworkInspect:output_type -> docker.v1.NetworkInspectResponse
